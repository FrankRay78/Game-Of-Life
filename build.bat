...
packages\ReportGenerator.4.8.0\tools\net47\ReportGenerator.exe -reports:TestResults\OpenCover.xml -targetdir:TestResults\ReportGenerator -reportTypes:"HtmlInline;HtmlChart;Cobertura;" -historydir:"..\..\persistent\Game-Of-Life\cover"
